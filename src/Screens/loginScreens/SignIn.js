    ...
    <ScrollView>
      <View style={styles.main}>
        ...
        <TouchableOpacity
          onPress={() => signin()}
          style={styles.btn}>
          <Text style={{ color: "#fff", fontFamily:'Jameel Noori Nastaleeq',fontSize:18}}> لاگ ان کریں </Text>
        </TouchableOpacity>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '80%', margin: 30 }}>
          <TouchableOpacity onPress={() => navigation.navigate('ForgatPassword')}>
            <Text style={styles.btnBelow}> پاس ورڈ بھول گیا </Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={() => navigation.navigate('SignUp')}>
            <Text style={styles.btnBelow}> نیا اکاؤنٹ رجسٹر کریں</Text>
          </TouchableOpacity>
        </View>
